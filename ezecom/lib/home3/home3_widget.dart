...
class _Home3WidgetState extends State<Home3Widget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.topDeals = await actions.getTopDealProductIDs();
    });
                  ...
                  child: Column(
                    ...
                    children: [
                      Stack(
                        children: [
                          Align(
                            alignment: AlignmentDirectional(2.09, -1.23),
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 15.0, 0.0, 0.0),
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(8.0),
                                child: Image.asset(
                                  'assets/images/plans_vector_left.png',
                                  width: 227.6,
                                  height: 162.1,
                                  fit: BoxFit.contain,
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  context.pushNamed(Test123Widget.routeName);
                                },
                              ),
                            ),
                          ),
                      ...
                      Container(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            _model.handlePlanSelection =
                                await actions.getPlanNameByIndex(
                              FFAppState().indexvalue,
                            );
                            if (_model.handlePlanSelection != 'false') {
                              _model.planid =
                                  await actions.createTransactionForPlan(
                                _model.handlePlanSelection!,
                                currentUserEmail,
                              );
                              if (_model.planid != 'false') {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'Purchase entry marked',
                                      style: TextStyle(
                                        color: FlutterFlowTheme.of(context)
                                            .primaryText,
                                      ),
