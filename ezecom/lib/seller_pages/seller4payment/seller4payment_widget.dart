...
import 'seller4payment_model.dart';
export 'seller4payment_model.dart';

class Seller4paymentWidget extends StatefulWidget {
  const Seller4paymentWidget({super.key});

  static String routeName = 'Seller4payment';
  static String routePath = '/seller4payment';

  @override
  State<Seller4paymentWidget> createState() => _Seller4paymentWidgetState();
}

class _Seller4paymentWidgetState extends State<Seller4paymentWidget> {
  late Seller4paymentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Seller4paymentModel());
