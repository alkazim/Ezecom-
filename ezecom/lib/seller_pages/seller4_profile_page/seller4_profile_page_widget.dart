...
import 'seller4_profile_page_model.dart';
export 'seller4_profile_page_model.dart';

class Seller4ProfilePageWidget extends StatefulWidget {
  const Seller4ProfilePageWidget({super.key});

  static String routeName = 'Seller4ProfilePage';
  static String routePath = '/seller4ProfilePage';

  @override
  State<Seller4ProfilePageWidget> createState() =>
      _Seller4ProfilePageWidgetState();
}

class _Seller4ProfilePageWidgetState extends State<Seller4ProfilePageWidget> {
  late Seller4ProfilePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Seller4ProfilePageModel());
