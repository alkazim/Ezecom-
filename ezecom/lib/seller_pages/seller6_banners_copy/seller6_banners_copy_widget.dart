...
import 'seller6_banners_copy_model.dart';
export 'seller6_banners_copy_model.dart';

class Seller6BannersCopyWidget extends StatefulWidget {
  const Seller6BannersCopyWidget({super.key});

  static String routeName = 'Seller6BannersCopy';
  static String routePath = '/seller6BannersCopy';

  @override
  State<Seller6BannersCopyWidget> createState() =>
      _Seller6BannersCopyWidgetState();
}

class _Seller6BannersCopyWidgetState extends State<Seller6BannersCopyWidget> {
  late Seller6BannersCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Seller6BannersCopyModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<SellerUserRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SellerUserRow> seller6BannersCopySellerUserRowList =
            snapshot.data!;

        final seller6BannersCopySellerUserRow =
            seller6BannersCopySellerUserRowList.isNotEmpty
                ? seller6BannersCopySellerUserRowList.first
                : null;
                    ...
                    title: Stack(
                      children: [
                        ...
                        if (responsiveVisibility(
                          ...
                          Align(
                            alignment: AlignmentDirectional(-0.98, -0.08),
                            child: Padding(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Container(
                                                                                    ...
                                                                                    child: Container(
                                                                                      width: double.infinity,
                                                                                      height: double.infinity,
                                                                                      child: custom_widgets.FFBannerImageUploader(
                                                                                        width: double.infinity,
                                                                                        height: double.infinity,
                                                                                        appStateVariableName: 'MobileBannerImage',
                                                                                        dimensionsVariableName: 'MobileBannerDimension',
                                                                                        minWidth: 300,
                                                                                        minHeight: 100,
                                                                                        maxWidth: 1400,
                                                                                        maxHeight: 600,
                                                                                        expectedAspectRatio: 2.58,
                                                                                        aspectRatioTolerance: 0.22,
                                                                                      ),
                                                                                    ),
                                                                                  ),
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            if ((_model.dDropDownValue != null && _model.dDropDownValue != '') &&
                                                                                (FFAppState().DesktopBannerImage != null && FFAppState().DesktopBannerImage != '') &&
                                                                                (FFAppState().MobileBannerImage != null && FFAppState().MobileBannerImage != '')) {
                                                                              ...
                                                                              if (_model.conversionCopy == true) {
                                                                                _model.uploadStatusCopyCopyCopy = await actions.uploadBannerImages(
                                                                                  FFAppState().MobileBannerImage,
                                                                                  FFAppState().DesktopBannerImage,
                                                                                );
                                                                                if (_model.uploadStatusCopyCopyCopy == true) {
