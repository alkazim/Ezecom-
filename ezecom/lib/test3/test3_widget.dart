...
class _Test3WidgetState extends State<Test3Widget> {
  ...
  void initState() {
    ...
    _model.searchFieldwebTextController ??= TextEditingController();
    _model.searchFieldwebFocusNode ??= FocusNode();
                                ...
                                Expanded(
                                  child: Builder(
                                    builder: (context) => TextFormField(
                                      controller:
                                          _model.searchFieldwebTextController,
                                      focusNode: _model.searchFieldwebFocusNode,
                              ...
                              children: [
                                ...
                                if (responsiveVisibility(
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      context
                                          .pushNamed(CartPage2Widget.routeName);
                                    },
                                    child: Container(
                                      decoration: BoxDecoration(
                                        shape: BoxShape.rectangle,
