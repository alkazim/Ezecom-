                  ...
                  children: [
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          children: [
                            ...
                            Align(
                              alignment: AlignmentDirectional(-0.56, 0.08),
                              child: Text(
                                'My Profile',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                    ...
                    Container(
                      ...
                      child: Stack(
                        children: [
                          Align(
                            alignment: AlignmentDirectional(-0.01, 0.33),
                            child: Container(
                              decoration: BoxDecoration(),
                              child: FFButtonWidget(
                                onPressed: () async {
                                  if (widget!.emailID!.isEmpty) {
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                                ...
                                                child: Container(
                                                  ...
                                                  child: FutureBuilder<
                                                    ...
                                                    builder:
                                                      ...
                                                      List<BuyerUserRow>
                                                          circleImageBuyerUserRowList =
                                                          snapshot.data!;

                                                      final circleImageBuyerUserRow =
                                                          circleImageBuyerUserRowList
                                                                  .isNotEmpty
                                                              ? circleImageBuyerUserRowList
                                                                  .first
                                        ...
                                        Align(
                                          alignment:
                                              AlignmentDirectional(-0.01, 0.33),
                                          child: Container(
                                            decoration: BoxDecoration(),
                                            child: FFButtonWidget(
                                              onPressed: () async {
