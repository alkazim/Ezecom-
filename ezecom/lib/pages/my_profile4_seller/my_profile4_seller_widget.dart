...
import 'my_profile4_seller_model.dart';
export 'my_profile4_seller_model.dart';

class MyProfile4SellerWidget extends StatefulWidget {
  const MyProfile4SellerWidget({
    super.key,
  ...
  static String routeName = 'MyProfile4Seller';
  static String routePath = '/myProfile4Seller';

  @override
  State<MyProfile4SellerWidget> createState() => _MyProfile4SellerWidgetState();
}

class _MyProfile4SellerWidgetState extends State<MyProfile4SellerWidget> {
  late MyProfile4SellerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyProfile4SellerModel());
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              _model.companyname =
                                  await SellerUserTable().queryRows(
                                queryFn: (q) => q,
                              );
                    ...
                    Padding(
                      ...
                      child: FutureBuilder<List<SellerUserRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<SellerUserRow> columnSellerUserRowList =
                              snapshot.data!;
                                  ...
                                  child: Container(
                                    ...
                                    child: FutureBuilder<List<SellerUserRow>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<SellerUserRow>
                                            rowSellerUserRowList =
                                            snapshot.data!;

                                        final rowSellerUserRow =
                                            rowSellerUserRowList.isNotEmpty
                                                ? rowSellerUserRowList.first
                                                : null;
