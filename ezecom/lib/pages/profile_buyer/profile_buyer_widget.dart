...
import 'profile_buyer_model.dart';
export 'profile_buyer_model.dart';

class ProfileBuyerWidget extends StatefulWidget {
  const ProfileBuyerWidget({super.key});

  static String routeName = 'ProfileBuyer';
  static String routePath = '/profileBuyer';

  @override
  State<ProfileBuyerWidget> createState() => _ProfileBuyerWidgetState();
}

class _ProfileBuyerWidgetState extends State<ProfileBuyerWidget> {
  late ProfileBuyerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileBuyerModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {});
      _model.approvalStaus = await actions.checkAccountApproval1(
        currentUserEmail,
      );
      if (_model.approvalStaus == 'approved') {
                                  ...
                                  child: SingleChildScrollView(
                                    child: Column(
                                      ...
                                      children: [
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: FutureBuilder<
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          List<BuyerUserRow>
                                                              containerBuyerUserRowList =
                                                              snapshot.data!;

                                                          final containerBuyerUserRow =
                                                              containerBuyerUserRowList
                                                                      .isNotEmpty
                                                                  ? containerBuyerUserRowList
                                                                      .first
                                        ...
                                        Align(
                                          alignment:
                                              AlignmentDirectional(0.0, 18.46),
                                          child: FutureBuilder<
                                              List<ClientTableRow>>(
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<ClientTableRow>
                                                  containerClientTableRowList =
                                                  snapshot.data!;

                                              final containerClientTableRow =
                                                  containerClientTableRowList
                                                          .isNotEmpty
                                                      ? containerClientTableRowList
                                                          .first
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            containerBuyerUserRow?.companyName,
                                                                            'Company_Name',
                                                                          ),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            containerBuyerUserRow?.contactNumber,
                                                                            'Contact_Number',
                                                                          ),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            containerBuyerUserRow?.companyAddress,
                                                                            'Company_Address',
                                                                          ),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
