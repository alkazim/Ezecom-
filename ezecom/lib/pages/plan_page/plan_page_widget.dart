...
class PlanPageWidget extends StatefulWidget {
  ...
  static String routePath = '/planPage';
...
class _PlanPageWidgetState extends State<PlanPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.type = await actions.getUserPlanType(
        currentUserEmail,
      );
    });
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      StreamBuilder<List<PlanTableRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<PlanTableRow> containerPlanTableRowList =
                              snapshot.data!;

                          final containerPlanTableRow =
                              containerPlanTableRowList.isNotEmpty
                                  ? containerPlanTableRowList.first
                                  : null;
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        valueOrDefault<String>(
                                          containerPlanTableRow?.planName,
                                          'Plan Name',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                  ...
                                  child: Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text(
                                          valueOrDefault<String>(
                                            containerPlanTableRow?.planDetails,
                                            'Plan_Details',
                                          ),
