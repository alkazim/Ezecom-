...
import 'home_page_seller2_model.dart';
export 'home_page_seller2_model.dart';

class HomePageSeller2Widget extends StatefulWidget {
  const HomePageSeller2Widget({super.key});

  static String routeName = 'HomePageSeller2';
  static String routePath = '/HomePage2';

  @override
  State<HomePageSeller2Widget> createState() => _HomePageSeller2WidgetState();
}

class _HomePageSeller2WidgetState extends State<HomePageSeller2Widget> {
  late HomePageSeller2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageSeller2Model());
      ...
      child: Scaffold(
        ...
        floatingActionButton: Visibility(
          ...
          child: FloatingActionButton(
            onPressed: () async {
              context.pushNamed(Seller0DashboardWidget.routeName);
            },
                                    ...
                                    child: Row(
                                      ...
                                      children: List.generate(
                                        ...
                                        final rowCategoriesTableRow =
                                            rowCategoriesTableRowList[rowIndex];
                                        return Padding(
                                          padding:
                                      ...
                                      onTap: () async {
                                        if (FFAppState().skip == true) {
                                          ...
                                          if ((FFAppState().Role == 'buyer') ||
                                              (FFAppState().Role == 'seller')) {
                                            context.pushNamed(
                                                FilterTopDealsWidget.routeName);
                                          } else {
                                            await showDialog(
                                              context: context,
                                              builder: (dialogContext) {
                            ...
                            child: Column(
                              ...
                              children: [
                                StreamBuilder<List<PublicProductsViewRow>>(
                                  stream: _model.rowSupabaseStream3 ??= SupaFlow
                                      .client
                                      .from("public_products_view")
                                      .stream(primaryKey: [
                                        'Product_id',
                                ...
                                Padding(
                                  ...
                                  child: StreamBuilder<
                                      List<PublicProductsViewRow>>(
                                    stream: _model.rowSupabaseStream4 ??=
                                        SupaFlow.client
                                            .from("public_products_view")
                                            .stream(primaryKey: [
                                              'Product_id',
                                ...
                                Padding(
                                  ...
                                  child: StreamBuilder<
                                      List<PublicProductsViewRow>>(
                                    stream: _model.rowSupabaseStream5 ??=
                                        SupaFlow.client
                                            .from("public_products_view")
                                            .stream(primaryKey: [
                                              'Product_id',
                                ...
                                Padding(
                                  ...
                                  child: StreamBuilder<
                                      List<PublicProductsViewRow>>(
                                    stream: _model.rowSupabaseStream6 ??=
                                        SupaFlow.client
                                            .from("public_products_view")
                                            .stream(primaryKey: [
                                              'Product_id',
                                                                      ...
                                                                      if (FFAppState()
                                                                        ...
                                                                        if ((FFAppState().Role ==
                                                                            ...
                                                                            (FFAppState().Role ==
                                                                                'seller')) {
                                                                          context
                                                                              .pushNamed(FilterFeaturedOfferWidget.routeName);
                                                                        } else {
                                                                          await showDialog(
                                                                            context:
                                                                                context,
