...
import 'select_quantity_model.dart';
export 'select_quantity_model.dart';

class SelectQuantityWidget extends StatefulWidget {
  const SelectQuantityWidget({super.key});

  @override
  State<SelectQuantityWidget> createState() => _SelectQuantityWidgetState();
}

class _SelectQuantityWidgetState extends State<SelectQuantityWidget>
    with TickerProviderStateMixin {
  late SelectQuantityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectQuantityModel());
