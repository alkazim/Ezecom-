...
class SellerProductsWidget extends StatefulWidget {
  ...
  @override
  State<SellerProductsWidget> createState() => _SellerProductsWidgetState();
}
...
class _SellerProductsWidgetState extends State<SellerProductsWidget> {
  ...
  void initState() {
    super.initState();
    print(
        '[SellerProductsWidget] Initializing widget for seller: ${widget.sellerEmail}');
    _fetchProducts();
  }
  ...
  Future<void> _fetchProducts() async {
    try {
      print(
          '[SellerProductsWidget] Fetching products for seller: ${widget.sellerEmail}');
      setState(() {
        isLoading = true;
        error = null;
      });
      ...
      final response = await Supabase.instance.client
          ...
          .neq('Approval', 'approved')
          .order('created_at', ascending: false);

      print(
          '[SellerProductsWidget] Successfully fetched ${response.length} products');
      ...
      print('[SellerProductsWidget] Error fetching products: $e');
      setState(() {
        error = e.toString();
        isLoading = false;
      });
  ...
  void _showProductDetails(Map<String, dynamic> product) {
    print(
        '[SellerProductsWidget] Opening product details for: ${product['Product_Name']}');
  ...
  String _formatDate(String? dateString) {
    ...
    try {
      ...
      print('[SellerProductsWidget] Error parsing date: $e');
      return dateString;
    }
  }
  ...
  Widget build(BuildContext context) {
    print(
        '[SellerProductsWidget] Building widget - Loading: $isLoading, Products: ${products.length}');
              ...
              children: [
                ...
                const Expanded(
                  ...
                  child: Text(
                    ...
                    textAlign: TextAlign.center, // Center align like data rows
                  ),
                ),
                const Expanded(
                  flex: 1,
...
// Content
  ...
  @override
  void dispose() {
    print('[SellerProductsWidget] Disposing widget');
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Add rejection reason if product is rejected
                        if (widget.product['Approval']
                                ?.toString()
                                .toUpperCase() ==
                            'REJECTED')
                          _buildDetailRow(
                              'Rejection Reason',
                              widget.product['Rejection_reason'] ??
                                  'No reason provided',
                              isLarge: isWeb),
