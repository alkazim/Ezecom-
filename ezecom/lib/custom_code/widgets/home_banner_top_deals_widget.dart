...
class HomeBannerTopDealsWidget extends StatefulWidget {
  // Renamed the widget
  final double? width;
  final double? height;
  ...
  const HomeBannerTopDealsWidget({
  ...
  @override
  State<HomeBannerTopDealsWidget> createState() =>
      _HomeBannerTopDealsWidgetState(); // Renamed the state class
}

class _HomeBannerTopDealsWidgetState extends State<HomeBannerTopDealsWidget> {
    ...
    try {
      ...
      for (var item in response) {
        if (item['Organization'] != null) {
          ...
          // Check if 'top deals' is 'true' (string) in the Organization JSON
