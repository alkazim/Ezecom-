...
class MobileHomeBannerWidget extends StatefulWidget {
  final double? width;
  final double? height;
  ...
  @override
  State<MobileHomeBannerWidget> createState() => _MobileHomeBannerWidgetState();
}

class _MobileHomeBannerWidgetState extends State<MobileHomeBannerWidget> {
    ...
    try {
      ...
      for (var item in response) {
        if (item['Organization'] != null) {
          ...
          // Check if 'mobileHome' is 'true' in the Organization JSON
          if (organization['mobileHome'] == "true") {
      ...
      print(
          'Banner Widget: Filtered to ${filteredRecords.length} records with mobileHome="true"');
