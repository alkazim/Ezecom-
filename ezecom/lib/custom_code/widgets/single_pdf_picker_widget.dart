...
class SinglePdfPickerWidget extends StatefulWidget {
  const SinglePdfPickerWidget({
    Key? key,
    this.width = 85,
    this.height = 60,
  ...
  @override
  State<SinglePdfPickerWidget> createState() => _SinglePdfPickerWidgetState();
}

class _SinglePdfPickerWidgetState extends State<SinglePdfPickerWidget> {
  ...
  String? _getAppStateValue() {
    ...
    switch (widget.appStateVariableName) {
      case 'CompanyRegistrationCertificatePDF':
        return FFAppState().CompanyRegistrationCertificatePDF;
      case 'TaxRegistrationCertificatePDF':
        return FFAppState().TaxRegistrationCertificatePDF;
      case 'OwnerDirectorIDCardPDF':
        return FFAppState().OwnerDirectorIDCardPDF;
      case 'FactoryCompanyimagePDF':
        return FFAppState().FactoryCompanyimagePDF;
      case 'ImportExportCertificatePDF':
        return FFAppState().ImportExportCertificatePDF;
      case 'LogoRegistrationCertificatePDF':
        return FFAppState().LogoRegistrationCertificatePDF;
      case 'TrademarkorLogoImagePDF':
        return FFAppState().TrademarkorLogoImagePDF;
      default:
  ...
  void _setAppStateValue(String value) {
    switch (widget.appStateVariableName) {
      case 'CompanyRegistrationCertificatePDF':
        FFAppState().CompanyRegistrationCertificatePDF = value;
        break;
      case 'TaxRegistrationCertificatePDF':
        FFAppState().TaxRegistrationCertificatePDF = value;
        break;
      case 'OwnerDirectorIDCardPDF':
        FFAppState().OwnerDirectorIDCardPDF = value;
        break;
      case 'FactoryCompanyimagePDF':
        FFAppState().FactoryCompanyimagePDF = value;
        break;
      case 'ImportExportCertificatePDF':
        FFAppState().ImportExportCertificatePDF = value;
        break;
      case 'LogoRegistrationCertificatePDF':
        FFAppState().LogoRegistrationCertificatePDF = value;
        break;
      case 'TrademarkorLogoImagePDF':
        FFAppState().TrademarkorLogoImagePDF = value;
        break;
      default:
        throw Exception(
            'Unknown app state variable: ${widget.appStateVariableName}');
