...
class NewArrivalsBannerWidget extends StatefulWidget {
  final double? width;
  final double? height;
  ...
  @override
  State<NewArrivalsBannerWidget> createState() =>
      _NewArrivalsBannerWidgetState();
}

class _NewArrivalsBannerWidgetState extends State<NewArrivalsBannerWidget> {
    ...
    try {
      ...
      for (var item in response) {
        if (item['Organization'] != null) {
          ...
          // Check if 'new arrivals' is 'true' in the Organization JSON
          if (organization['new arrivals'] == "true") {
      ...
      print(
          'Banner Widget: Filtered to ${filteredRecords.length} records with new arrivals="true"');
