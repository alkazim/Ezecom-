...
Future<List<int>> getNewArrivalProductIDs() async {
  ...
  try {
    ...
    final response = await supabase
        ...
        .eq('Status->>NewArrival', 'true')
        .eq('Status->>FeaturedOffer', 'false');
    // .eq('Approval', 'approved');

    print('Found ${response.length} matching products in New Arrival');
    ...
    print('Error in getNewArrivalIDs: $e');
    return []; // Changed from '' to []
  }
}
