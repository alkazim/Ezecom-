...
import 'payment_agent_through_cart_model.dart';
export 'payment_agent_through_cart_model.dart';

class PaymentAgentThroughCartWidget extends StatefulWidget {
  const PaymentAgentThroughCartWidget({
    super.key,
  ...
  static String routeName = 'PaymentAgentThroughCart';
  static String routePath = '/paymentAgentThroughCart';

  @override
  State<PaymentAgentThroughCartWidget> createState() =>
      _PaymentAgentThroughCartWidgetState();
}

class _PaymentAgentThroughCartWidgetState
    extends State<PaymentAgentThroughCartWidget> {
  late PaymentAgentThroughCartModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentAgentThroughCartModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {});
      _model.cartPriceAmount = await actions.getTotalPriceByEnquiryId(
        widget!.enquiryID!,
      );
      if (_model.cartPriceAmount != 'false') {
        FFAppState().cartVisible = true;
        safeSetState(() {});
      }
    });
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                                      ...
                                      child: FutureBuilder<List<BuyerUserRow>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          final textBuyerUserRow =
                                              textBuyerUserRowList.isNotEmpty
                              ...
                              children: [
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 10.0, 0.0, 0.0),
                                  child: Text(
                                    'Note : Agent Through Payment cart',
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                          ...
                          custom_widgets.EnquiryContainerAgent(
