...
import 'payment_factory_through_model.dart';
export 'payment_factory_through_model.dart';

class PaymentFactoryThroughWidget extends StatefulWidget {
  const PaymentFactoryThroughWidget({
    super.key,
  ...
  static String routeName = 'PaymentFactoryThrough';
  static String routePath = '/paymentFactoryThrough';

  @override
  State<PaymentFactoryThroughWidget> createState() =>
      _PaymentFactoryThroughWidgetState();
}

class _PaymentFactoryThroughWidgetState
    extends State<PaymentFactoryThroughWidget> {
  late PaymentFactoryThroughModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentFactoryThroughModel());
                            ...
                            Align(
                              ...
                              child: FutureBuilder<
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<GSTManufacturePlanDetailsRow>
                                      containerGSTManufacturePlanDetailsRowList =
                                      snapshot.data!;

                                  final containerGSTManufacturePlanDetailsRow =
                                      containerGSTManufacturePlanDetailsRowList
                                              .isNotEmpty
                                          ? containerGSTManufacturePlanDetailsRowList
                                              .first
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            image: DecorationImage(
                                              fit: BoxFit.contain,
                                              image: Image.asset(
                                                'assets/images/pngwing.com_-_2025-02-27T115633.030_1.png',
                                              ).image,
                                            ),
                                            borderRadius:
                                                BorderRadius.circular(12.0),
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            image: DecorationImage(
                                              fit: BoxFit.contain,
                                              image: Image.asset(
                                                'assets/images/pngwing.com_-_2025-02-27T120543.584_1.png',
                                              ).image,
                                            ),
                                            borderRadius:
                                                BorderRadius.circular(12.0),
                                  ...
                                  child: FutureBuilder<List<ProductsTableRow>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final buttonProductsTableRow =
                                          buttonProductsTableRowList.isNotEmpty
                                              ? buttonProductsTableRowList.first
                                              : null;
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              builder: (context, snapshot) {
                                                                                ...
                                                                                return Text(
                                                                                  valueOrDefault<String>(
                                                                                    textEnquiryTableFactoryThroughRow?.gSTTotalPrice?.toString(),
                                                                                    'total price',
                                                                                  ),
                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                        font: GoogleFonts.poppins(
