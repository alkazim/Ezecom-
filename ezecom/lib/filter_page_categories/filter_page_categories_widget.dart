...
import 'filter_page_categories_model.dart';
export 'filter_page_categories_model.dart';

class FilterPageCategoriesWidget extends StatefulWidget {
  const FilterPageCategoriesWidget({
    super.key,
  ...
  static String routeName = 'FilterPageCategories';
  static String routePath = '/filterPageCategories';

  @override
  State<FilterPageCategoriesWidget> createState() =>
      _FilterPageCategoriesWidgetState();
}

class _FilterPageCategoriesWidgetState
    extends State<FilterPageCategoriesWidget> {
  late FilterPageCategoriesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterPageCategoriesModel());
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            columnPublicProductsViewRow.description,
                                                                            '[ description ]',
                                                                          ).maybeHandleOverflow(
                                                                            maxChars:
                                                                                40,
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          custom_widgets.DynamicCategoryProducts(
                            width: double.infinity,
                            height: MediaQuery.sizeOf(context).height * 1.0,
