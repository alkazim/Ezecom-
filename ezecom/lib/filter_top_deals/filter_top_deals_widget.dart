...
import 'filter_top_deals_model.dart';
export 'filter_top_deals_model.dart';

class FilterTopDealsWidget extends StatefulWidget {
  const FilterTopDealsWidget({super.key});

  static String routeName = 'filterTopDeals';
  static String routePath = '/filterTopDeals';

  @override
  State<FilterTopDealsWidget> createState() => _FilterTopDealsWidgetState();
}

class _FilterTopDealsWidgetState extends State<FilterTopDealsWidget> {
  late FilterTopDealsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterTopDealsModel());
                                    ...
                                    Container(
                                      ...
                                      child: Container(
                                        ...
                                        height:
                                            MediaQuery.sizeOf(context).height *
                                                1.0,
                                        child: custom_widgets.DynamicTopDeals(
                                          width: double.infinity,
