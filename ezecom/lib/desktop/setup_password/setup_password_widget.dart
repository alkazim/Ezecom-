...
import 'setup_password_model.dart';
export 'setup_password_model.dart';

class SetupPasswordWidget extends StatefulWidget {
  const SetupPasswordWidget({super.key});

  static String routeName = 'SetupPassword';
  static String routePath = '/setupPassword';

  @override
  State<SetupPasswordWidget> createState() => _SetupPasswordWidgetState();
}

class _SetupPasswordWidgetState extends State<SetupPasswordWidget> {
  late SetupPasswordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SetupPasswordModel());
                          ...
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/images/Group_143725985.png',
                                  width: 200.0,
                                  height: 200.0,
                                  fit: BoxFit.cover,
                                ),
