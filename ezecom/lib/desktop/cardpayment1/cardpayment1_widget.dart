...
import 'cardpayment1_model.dart';
export 'cardpayment1_model.dart';

class Cardpayment1Widget extends StatefulWidget {
  const Cardpayment1Widget({super.key});

  static String routeName = 'cardpayment1';
  static String routePath = '/cardpayment1';

  @override
  State<Cardpayment1Widget> createState() => _Cardpayment1WidgetState();
}

class _Cardpayment1WidgetState extends State<Cardpayment1Widget> {
  late Cardpayment1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Cardpayment1Model());
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        await launchURL(
                                                            'https://mail.google.com/mail/u/0/?fs=1&to=contact@ezecom.shop&su=Hello&body=Hi+there!&tf=cm');
                                                      },
                                                      child: Text(
                                                        'contact@ezecom.shop',
                                                        style:
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  await launchURL(
                                                      'https://www.instagram.com/ezecomofficial/');
                                                },
                                                child: FaIcon(
